        ...
        stage('Prepare Environment') {
          ...
          stage("Build (Compile App)") {
            ...
            steps {
                ...
                sh 'python manage.py test --with-coverage --cover-erase --cover-package=skill_app --with-xunit --xunit-file=xunittest.xml --cover-branches --cover-html --settings=lxp_course_topic_service.settings.test'
