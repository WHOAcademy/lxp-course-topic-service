          ...
          stage("Build (Compile App)") {
            ...
            steps {
                script {
                    ...
                    env.SECRET_KEY = 'x!f$o_*q)a(8etl7trr@htu@=@_ayeb)h6bi(*&vzpiitrvvpz' //TODO: get it from secret vault
                ...
                sh 'python manage.py test --with-coverage --cover-erase --cover-package=course_app --with-xunit --xunit-file=xunittest.xml --cover-branches --cover-html --settings=lxp_course_topic_service.settings.test'
